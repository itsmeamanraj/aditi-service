    ...
    <div class="row g-4">
        <div class="col-12 col-md-6">
            <div class="p-4 card-custom">
                ...
                <p>
                    ...
                    <a href="https://wa.me/1234567890" class="text-success text-decoration-none" target="_blank">
                ...
                <div class="mt-3">
                    <a href="<?= base_url('servicedetail') ?>" class="btn btn-custom">
        ...
        <div class="col-12 col-md-6">
            <div class="p-4 card-custom">
                ...
                <div class="mt-3">
                    <a href="#details" class="btn btn-custom">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-info-circle me-1" viewBox="0 0 16 16">
                            <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                            <path
